...
const OPENROUTER_KEY_MISSING_MESSAGE =
  "No OpenRouter API key is configured for this deployment yet. Add one in Settings → Integrations (or set OPENROUTER_API_KEY in the environment and restart), then confirm here.";
